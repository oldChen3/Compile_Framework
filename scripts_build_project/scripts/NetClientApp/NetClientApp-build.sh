...
readonly APP_COMPILE_DIR="${BASE_DIR}/Apps/NetClientApp/build"
readonly APP_BIN_DIR="${BASE_DIR}/Apps/NetClientApp/bin"
readonly APP_TARGET="${APP_BIN_DIR}/NetClientApp"
